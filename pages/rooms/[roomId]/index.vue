        ...
        <div class="d-none d-md-block position-relative">
          <div class="d-flex gap-2 rounded-3xl overflow-hidden">
            <div style="width: 52.5vw">
              <img
                class="w-100"
                :src="`${baseURL}images/room-${route.params.roomId}-1.png`"
                :alt="`room-${route.params.roomId}-1`"
              />
            </div>
            <div class="d-flex flex-wrap gap-md-2" style="width: 42.5vw">
              <div class="d-flex gap-md-2">
                <img
                  class="w-50"
                  :src="`${baseURL}images/room-${route.params.roomId}-2.png`"
                  :alt="`room-${route.params.roomId}-2`"
                />
                <img
                  class="w-50"
                  :src="`${baseURL}images/room-${route.params.roomId}-3.png`"
                  :alt="`room-${route.params.roomId}-3`"
                />
              </div>
              <div class="d-flex gap-md-2">
                <img
                  class="w-50"
                  :src="`${baseURL}images/room-${route.params.roomId}-4.png`"
                  :alt="`room-${route.params.roomId}-4`"
                />
                <img
                  class="w-50"
                  :src="`${baseURL}images/room-${route.params.roomId}-5.png`"
                  :alt="`room-${route.params.roomId}-5`"
                />
              </div>
            </div>
          </div>
